      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-border/60 bg-primary/5 p-6 glow-card">
          ...
          <div className="grid grid-cols-2 gap-4">
            {focusAreas.map((area) => {
              ...
              return (
                <div
                  key={area.title}
                  className="p-6 rounded-xl border border-border bg-card/50 hover:bg-card transition-all duration-300 group glow-card"
                >
        ...
        <div className="mt-16 rounded-3xl border border-border/60 bg-gradient-to-br from-card/70 via-card/40 to-background/80 p-6 md:p-8 glow-card">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-2 rounded-lg bg-primary/15 border border-border/60">
          ...
          <div className="grid gap-4 lg:grid-cols-2 items-stretch">
            ...
            {/* School & College */}
            <div className="h-full rounded-2xl border border-border/60 bg-background/30 p-5 md:p-6 flex flex-col glow-card">
              ...
              <div className="space-y-4 flex-1">
                <div className="rounded-xl border border-border/60 bg-card/40 p-4 glow-card">
                  ...
                  <div className="mt-3 space-y-2">
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-md bg-primary/10 text-primary border border-border/60">
                ...
                <div className="rounded-xl border border-border/60 bg-card/40 p-4 glow-card">
                  ...
                  <div className="mt-3 space-y-3">
                    <div>
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-md bg-primary/10 text-primary border border-border/60">
            ...
            <div className="h-full rounded-2xl border border-border/60 bg-background/30 p-5 md:p-6 flex flex-col glow-card">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-4">
                <span className="px-2 py-1 text-xs rounded-md bg-secondary border border-border/60">2022 - Present</span>
                <span className="px-2 py-1 text-xs rounded-md bg-primary/10 text-primary border border-border/60">CGPA 3.61 / 4.00</span>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={course}
                      className="px-2.5 py-1 text-xs rounded-md bg-primary/10 text-primary border border-border/60"
                    >
                      {course}
                    </span>
                  ))}
          ...
          {/* Research Interests */}
          <div className="mt-6 rounded-2xl border border-border/60 bg-background/30 p-5 md:p-6 glow-card">
